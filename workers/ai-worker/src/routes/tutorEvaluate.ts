...
/**
 * Parses & validates the JSON body for code evaluation.
 * Returns an an object with the parsed body.
 */
...
/**
 * Builds message array for AI code feedback. Only supports python right now.
 */
...
/**
 * Processes an LLM tool call and returns HTTP Response.
 */
