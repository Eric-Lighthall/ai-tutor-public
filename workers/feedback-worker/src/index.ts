// This cloudflare worker script handles feedback submissions.
// Handles JSON and multipart POST requests.
// Feedback text & image references are stored in KV
// Actual image files are sored in R2

/*  Cloudflare worker bindings
	KV:
		FEEDBACK_KV - feedback json
		STATS_KV - running byte counter (protect against 10GB quota)

	R2:
		FEEDBACK_R2 - binary image storage
*/
